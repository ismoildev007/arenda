...
<header style="width:100%; margin-left: 0; left: 0;" class="nxl-header">
    <div class="header-wrapper">
        ...
        <div class="header-left d-flex align-items-center gap-4">
            ...
            <div class=" d-none nxl-lavel-mega-menu d-none">
                <div class="nxl-lavel-mega-menu-toggle d-flex d-lg-none">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                        <img style="height: 40px; object-fit: cover;"  src="{{ auth()->guard('client')->user()->image ? asset('storage/avatars/' . auth()->guard('client')->user()->image) : asset('/assets/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar me-0">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img style="height: 40px; object-fit: cover;" src="{{ auth()->guard('client')->user()->image ? asset('storage/avatars/' . auth()->guard('client')->user()->image) : asset('/assets/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar">
                                <div>
                                    <h6 class="text-dark mb-0">{{ auth()->guard('client')->user()->first_name ?? 'user nomi qoshiladi'}} {{ auth()->guard('client')->user()->last_name ?? 'user nomi qoshiladi'}} <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                    <span class="fs-12 fw-medium text-muted">{{ auth()->guard('client')->user()->email ?? 'user nomi qoshiladi'}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown">
...
<header style="left:0" class="nxl-header">
    <div class="header-wrapper">
        <!--! [Start] Header Left !-->
        <div class="header-left d-flex  align-items-center gap-4">
            <!--! [Start] nxl-head-mobile-toggler !-->
            <a href="javascript:void(0);" class="nxl-head-mobile-toggler d-none" id="mobile-collapse">
                <div class="hamburger hamburger--arrowturn">
                    <div class="hamburger-box">
                        <div class="hamburger-inner"></div>
                    </div>
            ...
            <!--! [End] nxl-navigation-toggle !-->
            <!--! [Start] nxl-lavel-mega-menu-toggle !-->
            <div class="nxl-lavel-mega-menu-toggle d-none d-lg-none">
                <a href="javascript:void(0);" id="nxl-lavel-mega-menu-open">
                    <i class="feather-align-left"></i>
                </a>
            </div>
            <!--! [End] nxl-lavel-mega-menu-toggle !-->
            <!--! [Start] nxl-lavel-mega-menu !-->
            <div class="nxl-drp-link d-none nxl-lavel-mega-menu">
                <div class="nxl-lavel-mega-menu-toggle d-flex d-lg-none">
                    <a href="javascript:void(0)" id="nxl-lavel-mega-menu-hide">
                        <i class="feather-arrow-left me-2"></i>
                        <span>Back</span>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="{{ auth()->guard('client')->user()->image ? asset('storage/avatars/' . auth()->guard('client')->user()->image) : asset('/assets/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar">
                                <div>
                                    <h6 class="text-dark mb-0">{{ auth()->guard('client')->user()->first_name ?? 'user nomi qoshiladi'}} {{ auth()->guard('client')->user()->last_name ?? 'user nomi qoshiladi'}} <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                    <span class="fs-12 fw-medium text-muted">{{ auth()->guard('client')->user()->email ?? 'user nomi qoshiladi'}}</span>
                                </div>
