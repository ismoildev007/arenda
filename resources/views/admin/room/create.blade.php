            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Yangi Xona Qo'shish</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('rooms.index') }}">Xonalar</a></li>
                        <li class="breadcrumb-item">Yangi xona qo'shish</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card-header p-0">
                        <ul class="nav nav-tabs flex-wrap w-100 text-center customers-nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item flex-fill border-top" role="presentation">
                                <a href="javascript:void(0);" class="nav-link text-start">Yangi xona ma'lumotlarini kiriting:</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="card-body personal-info">
                                <form action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="numberInput" name="number" placeholder="Xona raqamini kiriting" value="{{ old('number') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                            <label for="sizeInput" class="fw-semibold">O'lcham m <sup>2</sup>:</label>
                                        </div>
                                        <div class="col-lg-8">
                                            <input type="number" class="form-control" id="sizeInput" name="size" placeholder="O'lchamni kiritingm m kv" value="{{ old('size') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" step="0.01" class="form-control" id="priceInput" name="price_per_sqm" placeholder="Kvadrat metr narxini kiriting" value="{{ old('price_per_sqm') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="status" id="statusSelect" class="form-control max-select">
                                                <option value="noactive" {{ old('status') === 'noactive' ? 'selected' : '' }}>Noactive</option>
                                                <option value="active" {{ old('status') === 'active' ? 'selected' : '' }}>Active</option>
                                                <option value="bron" {{ old('status') === 'bron' ? 'selected' : '' }}>Bron</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
