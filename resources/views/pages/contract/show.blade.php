                        ...
                        <div class="card border-top-0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="billingTab" role="tabpanel">
                                    ...
                                    <div class="card mb-5 m-4" style="width: 25rem;">
                                        <img src="{{ $contract->room->images ? asset('storage/' . $contract->room->images[0]) : asset('/assets/images/default-room.png') }}" class="card-img-top" alt="Room Image">
